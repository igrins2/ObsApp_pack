...
################################################################################
## Form generated from reading UI file 'ObsAppMaOkXv.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.groupBox_InstrumentStatus.setGeometry(QRect(10, 10, 251, 325))
        sizePolicy.setHeightForWidth(self.groupBox_InstrumentStatus.sizePolicy().hasHeightForWidth())
        self.groupBox_InstrumentStatus.setSizePolicy(sizePolicy)
        font = QFont()
        font.setPointSize(8)
        ...
        font1.setBold(False)
        self.label_g1_9.setFont(font1)
        self.label_g1_9.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.label_g1_9, 9, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_temp_detK, 8, 1, 1, 1)
        ...
        self.label_g1_7.setFont(font1)
        self.label_g1_7.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.label_g1_7, 7, 0, 1, 1)

        self.label_g1_10 = QLabel(self.groupBox_InstrumentStatus)
        self.label_g1_10.setObjectName(u"label_g1_10")
        sizePolicy.setHeightForWidth(self.label_g1_10.sizePolicy().hasHeightForWidth())
        self.label_g1_10.setSizePolicy(sizePolicy)
        self.label_g1_10.setFont(font1)
        self.label_g1_10.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.label_g1_10, 10, 0, 1, 1)

        self.label_g1_12 = QLabel(self.groupBox_InstrumentStatus)
        self.label_g1_12.setObjectName(u"label_g1_12")
        sizePolicy.setHeightForWidth(self.label_g1_12.sizePolicy().hasHeightForWidth())
        self.label_g1_12.setSizePolicy(sizePolicy)
        self.label_g1_12.setFont(font1)
        self.label_g1_12.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.label_g1_12, 12, 0, 1, 1)
        ...
        self.label_g1_4.setFont(font1)
        self.label_g1_4.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.label_g1_4, 4, 0, 1, 1)

        self.label_heater_detH = QLabel(self.groupBox_InstrumentStatus)
        self.label_heater_detH.setObjectName(u"label_heater_detH")
        sizePolicy.setHeightForWidth(self.label_heater_detH.sizePolicy().hasHeightForWidth())
        self.label_heater_detH.setSizePolicy(sizePolicy)
        self.label_heater_detH.setFont(font2)
        self.label_heater_detH.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.label_heater_detH, 10, 1, 1, 1)

        self.label_g1_6 = QLabel(self.groupBox_InstrumentStatus)
        self.label_g1_6.setObjectName(u"label_g1_6")
        sizePolicy.setHeightForWidth(self.label_g1_6.sizePolicy().hasHeightForWidth())
        self.label_g1_6.setSizePolicy(sizePolicy)
        self.label_g1_6.setFont(font1)
        self.label_g1_6.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.label_g1_6, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_action_state, 5, 1, 1, 1)
        ...
        self.label_g1_1.setFont(font1)
        self.label_g1_1.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.label_g1_1, 1, 0, 1, 1)

        self.label_heater_detS = QLabel(self.groupBox_InstrumentStatus)
        self.label_heater_detS.setObjectName(u"label_heater_detS")
        sizePolicy.setHeightForWidth(self.label_heater_detS.sizePolicy().hasHeightForWidth())
        self.label_heater_detS.setSizePolicy(sizePolicy)
        self.label_heater_detS.setFont(font2)
        self.label_heater_detS.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.label_heater_detS, 12, 1, 1, 1)
        ...
        self.label_g1_5.setFont(font1)
        self.label_g1_5.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.label_g1_5, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_GMP_connection, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_temp_detH, 7, 1, 1, 1)

        self.label_heater_detK = QLabel(self.groupBox_InstrumentStatus)
        self.label_heater_detK.setObjectName(u"label_heater_detK")
        sizePolicy.setHeightForWidth(self.label_heater_detK.sizePolicy().hasHeightForWidth())
        self.label_heater_detK.setSizePolicy(sizePolicy)
        self.label_heater_detK.setFont(font2)
        self.label_heater_detK.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.label_heater_detK, 11, 1, 1, 1)

        self.label_g1_11 = QLabel(self.groupBox_InstrumentStatus)
        self.label_g1_11.setObjectName(u"label_g1_11")
        sizePolicy.setHeightForWidth(self.label_g1_11.sizePolicy().hasHeightForWidth())
        self.label_g1_11.setSizePolicy(sizePolicy)
        self.label_g1_11.setFont(font1)
        self.label_g1_11.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.label_g1_11, 11, 0, 1, 1)
        ...
        self.label_g1_2.setFont(font1)
        self.label_g1_2.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.label_g1_2, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_state, 4, 1, 1, 1)
        ...
        self.label_g1_8.setFont(font1)
        self.label_g1_8.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.label_g1_8, 8, 0, 1, 1)

        self.label_vacuum = QLabel(self.groupBox_InstrumentStatus)
        self.label_vacuum.setObjectName(u"label_vacuum")
        sizePolicy.setHeightForWidth(self.label_vacuum.sizePolicy().hasHeightForWidth())
        self.label_vacuum.setSizePolicy(sizePolicy)
        self.label_vacuum.setFont(font2)
        self.label_vacuum.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.label_vacuum, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_is_health, 1, 1, 1, 1)
        ...
        self.label_g1_3.setFont(font1)
        self.label_g1_3.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.label_g1_3, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_temp_detS, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_GDSN_connection, 2, 1, 1, 1)
        ...
        font3.setBold(True)
        self.label_g1.setFont(font3)
        self.label_g1.setAlignment(Qt.AlignCenter)

        self.gridLayout.addWidget(self.label_g1, 0, 0, 1, 2)
        ...
        self.groupBox_ScienceObservation.setGeometry(QRect(10, 337, 250, 231))
        sizePolicy.setHeightForWidth(self.groupBox_ScienceObservation.sizePolicy().hasHeightForWidth())
        self.groupBox_ScienceObservation.setSizePolicy(sizePolicy)
        ...
        self.groupBox_SlitViewCamera.setGeometry(QRect(580, 10, 311, 479))
        sizePolicy.setHeightForWidth(self.groupBox_SlitViewCamera.sizePolicy().hasHeightForWidth())
        self.groupBox_SlitViewCamera.setSizePolicy(sizePolicy)
        ...
        self.gridLayout_5.addWidget(self.e_svc_exp_time, 4, 5, 1, 4)
        ...
        self.gridLayout_5.addWidget(self.bt_single, 5, 4, 1, 5)

        self.bt_center = QPushButton(self.groupBox_SlitViewCamera)
        ...
        self.gridLayout_5.addWidget(self.label_g3_2, 2, 0, 1, 4)
        ...
        self.gridLayout_5.addWidget(self.label_g3_3, 3, 0, 1, 5)
        ...
        self.gridLayout_5.addWidget(self.label_g3_1, 1, 0, 1, 4)
        ...
        self.bt_minus_p = QPushButton(self.groupBox_SlitViewCamera)
        ...
        self.gridLayout_5.addWidget(self.chk_auto_save, 7, 2, 1, 4)
        ...
        self.gridLayout_5.addWidget(self.label_svc_filename, 1, 4, 1, 5)
        ...
        self.gridLayout_5.addWidget(self.label_svc_state, 2, 4, 1, 5)
        ...
        self.gridLayout_5.addWidget(self.bt_set_guide_star, 9, 2, 1, 3)
        ...
        self.gridLayout_5.addWidget(self.label_g3_4, 4, 0, 1, 5)
        ...
        self.gridLayout_5.addWidget(self.e_svc_fowler_number, 3, 5, 1, 4)
        ...
        self.groupBox_zscale.setGeometry(QRect(580, 490, 311, 79))
        sizePolicy.setHeightForWidth(self.groupBox_zscale.sizePolicy().hasHeightForWidth())
        self.groupBox_zscale.setSizePolicy(sizePolicy)
        ...
        self.label_messagebar.setGeometry(QRect(10, 570, 571, 25))
        ...
        self.frame_expand.setGeometry(QRect(260, 14, 161, 161))
        ...
        self.frame_fitting.setGeometry(QRect(420, 14, 161, 161))
        sizePolicy.setHeightForWidth(self.frame_fitting.sizePolicy().hasHeightForWidth())
        self.frame_fitting.setSizePolicy(sizePolicy)
        ...
        self.frame_svc.setGeometry(QRect(260, 174, 321, 321))
        ...
        self.frame_profile.setGeometry(QRect(260, 494, 321, 75))
        ...
        QWidget.setTabOrder(self.bt_repeat_filesave, self.bt_center)
        QWidget.setTabOrder(self.bt_center, self.bt_set_guide_star)
        QWidget.setTabOrder(self.bt_set_guide_star, self.chk_off_slit)
        QWidget.setTabOrder(self.chk_off_slit, self.bt_plus_p)
        QWidget.setTabOrder(self.bt_plus_p, self.bt_plus_q)
        QWidget.setTabOrder(self.bt_plus_q, self.bt_minus_p)
        QWidget.setTabOrder(self.bt_minus_p, self.bt_minus_q)
        QWidget.setTabOrder(self.bt_minus_q, self.e_offset)
        QWidget.setTabOrder(self.e_offset, self.bt_slow_guide)
        QWidget.setTabOrder(self.bt_slow_guide, self.e_averaging_number)
        QWidget.setTabOrder(self.e_averaging_number, self.radio_raw)
        QWidget.setTabOrder(self.radio_raw, self.radio_sub)
        QWidget.setTabOrder(self.radio_sub, self.bt_mark_sky)
        QWidget.setTabOrder(self.bt_mark_sky, self.radio_zscale)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_g1_10.setText(QCoreApplication.translate("Dialog", u"Heater H (%):", None))
        self.label_g1_12.setText(QCoreApplication.translate("Dialog", u"Heater S (%):", None))
        ...
        self.label_g1_6.setText(QCoreApplication.translate("Dialog", u"Press (Torr):", None))
        self.label_action_state.setText(QCoreApplication.translate("Dialog", u"Idle", None))
        self.label_g1_1.setText(QCoreApplication.translate("Dialog", u"IGRINS-2 Health:", None))
        ...
        self.label_g1_11.setText(QCoreApplication.translate("Dialog", u"Heater K (%):", None))
